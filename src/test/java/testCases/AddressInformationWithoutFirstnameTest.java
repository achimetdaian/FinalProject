...
public class AddressInformationWithoutFirstnameTest extends BasePage {
    @Test
    public void AddressInformationFirstname() throws InterruptedException {
        ...
        Assert.assertTrue(element.contains("First Name is required"));
    }
}
