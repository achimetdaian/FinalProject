...
public class AddressInformationWithoutAddressTest extends BasePage {
    @Test
    public void AddressInformationAddress() throws InterruptedException {
        ...
        Assert.assertTrue(element.contains("Address is required"));
    }
}
